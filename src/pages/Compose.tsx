...
import { Calendar as CalendarIcon, Twitter, Instagram, Facebook, Image, Link, AtSign, Hash, Clock, Save, SendHorizontal } from 'lucide-react';
                ...
                <TabsContent value="twitter" className="border rounded-lg p-4 bg-white">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1">Your post content will appear here. Add text in the composer to see the preview.</p>
                    </div>
                  </div>
                </TabsContent>
